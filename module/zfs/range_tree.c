    ...
    uint64_t gap)
{
	...
	rt->rt_start = start;
	rt->rt_shift = shift;
	rt->rt_zfs_btree_compare = zfs_btree_compare;
...
/* ARGSUSED */
void
rt_zfs_btree_create(range_tree_t *rt, void *arg)
{
	...
	zfs_btree_create(size_tree, rt->rt_zfs_btree_compare, size);
}

/* ARGSUSED */
void
rt_zfs_btree_destroy(range_tree_t *rt, void *arg)
{
	zfs_btree_t *size_tree = arg;
...
/* ARGSUSED */
void
rt_zfs_btree_add(range_tree_t *rt, range_seg_t *rs, void *arg)
{
	zfs_btree_t *size_tree = arg;
...
/* ARGSUSED */
void
rt_zfs_btree_remove(range_tree_t *rt, range_seg_t *rs, void *arg)
{
	zfs_btree_t *size_tree = arg;
...
/* ARGSUSED */
void
rt_zfs_btree_vacate(range_tree_t *rt, void *arg)
{
	zfs_btree_t *size_tree = arg;
	zfs_btree_clear(size_tree);
	zfs_btree_destroy(size_tree);

	rt_zfs_btree_create(rt, arg);
}

range_tree_ops_t rt_zfs_btree_ops = {
	.rtop_create = rt_zfs_btree_create,
	.rtop_destroy = rt_zfs_btree_destroy,
	.rtop_add = rt_zfs_btree_add,
	.rtop_remove = rt_zfs_btree_remove,
	.rtop_vacate = rt_zfs_btree_vacate
};
